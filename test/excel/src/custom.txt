...
# openpyxl/packaging/custom.py:CustomPropertyList
...
# openpyxl/packaging/custom.py:CustomPropertyList
    ...
    def from_tree(cls, tree):
        ...
        for prop in prop_list.property:
            ...
            if prop.name is None: # patch for skipping invalid property
                warn(f"Skipping unnamed custom property with value {value}")
                continue
